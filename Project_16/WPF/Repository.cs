    ...
    public class Repository
    {
        ...
        public Repository(string pathToDB, string password)
        {
            ...
            AccessConnectionString = $@"Provider=Microsoft.ACE.OLEDB.12.0;" +
                                     $@"Data Source={@"C:\Users\Ivan\Documents\GitHub\Projects\Project_16\DataBases"}\OrdersDatabase.accdb;" +
                                     $@"Jet OLEDB:Database Password={123};";
            LocalDBConnectionString = $@"Data Source=(localdb)\MSSQLLocalDB;" +
                                     $@"AttachDbFilename={@"C:\Users\Ivan\Downloads\HW16_OnlineShop-master\HW16_OnlineShop-master\DataBases"}\CustomersDatabase.mdf;" +
